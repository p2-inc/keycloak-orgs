...
export const PingOneWizard: FC = () => {
  ...
  //       message:
  //         "Configuration successfully validated with PingOne IdP. Continue to next step.",
  //     };
  //   } catch (e) {
  //     return {
  //       status: API_STATUS.ERROR,
  //       message:
  //         "Configuration validation failed with PingOne IdP. Check URL and try again.",
  //     };
  //   }
  // };
  ...
  const steps = [
    ...
    {
      id: 4,
      name: "Step 4: Upload PingOne IdP Information",
