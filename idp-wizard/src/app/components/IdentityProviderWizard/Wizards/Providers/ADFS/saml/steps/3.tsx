  ...
  const instructions: InstructionProps[] = [
    {
      ...
      component: <StepImage src={Images.ADFS_SAML_4} alt="Step 3.1" />,
    },
    {
      text: (
        <div>
      ...
      component: <StepImage src={Images.ADFS_SAML_5} alt="Step 3.2" />,
    },
    {
      text: (
        <div>
      ...
      component: <StepImage src={Images.ADFS_SAML_6} alt="Step 3.3" />,
    },
  ];
