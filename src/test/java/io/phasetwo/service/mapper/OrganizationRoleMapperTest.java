...
class OrganizationRoleMapperTest extends AbstractOrganizationTest {
    ...
    void shouldConfigureOrganizationRoleOidcProtocolMapper() throws Exception {
        ...
        List<String> roles = List.of(OrganizationAdminAuth.ORG_ROLE_VIEW_ORGANIZATION, OrganizationAdminAuth.ORG_ROLE_MANAGE_ORGANIZATION);
        ...
        TokenVerifier<AccessToken> verifier = TokenVerifier.create(keycloak.tokenManager().getAccessTokenString(), AccessToken.class);
        verifier.parse();
