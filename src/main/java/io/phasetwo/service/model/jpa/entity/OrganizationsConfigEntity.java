...
@NamedQueries({
  @NamedQuery(
      ...
      query = "SELECT config FROM OrganizationsConfigEntity config WHERE config.realmId = :realmId")
})
@Entity
@Table(
...
public class OrganizationsConfigEntity {
  ...
  public boolean equals(Object o) {
    ...
    return createAdminUser == that.createAdminUser
        && sharedIdps == that.sharedIdps
