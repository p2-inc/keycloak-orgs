...
public class JpaOrganizationsConfigProvider implements OrganizationsConfigProvider {
  ...
  @Override
  public OrganizationsConfigModel addConfig(RealmModel realm, OrganizationsConfig config) {
  ...
  public OrganizationsConfigAdapter update(
      RealmModel realm, OrganizationsConfigModel existingConfig) {
    OrganizationsConfigEntity entity = new OrganizationsConfigEntity();
