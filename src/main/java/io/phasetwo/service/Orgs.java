...
public class Orgs {
  ...
  public static final String ORG_DOMAIN_CONFIG_KEY = "home.idp.discovery.domains"; //also the default in sven-torben impl
  ...
  public static final String ORG_CONFIG_MULTIPLE_IDPS_KEY = "_providerConfig.orgs.config.multipleIdps";
