...
### Organization Tier (experimental)

It is possible to assign realm roles to an Organization under the concept of "tiers". Those tiers can have an expiration date and are inherited by organization members through token mappers.
For more information you can refer to [organization-tiers](./docs/organization-tiers.md).
