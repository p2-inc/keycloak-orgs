        ...
        >
          <div
            className={cs(
              ...
              {
                "bg-p2gray-900 dark:bg-white dark:group-enabled:text-zinc-800 dark:group-enabled:group-hover:bg-p2dark-1000 dark:group-enabled:group-hover:text-zinc-200 group-enabled:text-white group-enabled:group-hover:bg-p2gray-800 group-disabled:bg-neutral-400 group-disabled:text-white/50":
                  isBlackButton,
                "bg-neutral-50 dark:bg-p2dark-1000 dark:group-enabled:text-zinc-200 group-enabled:text-p2gray-900 group-disabled:text-p2gray-900/50":
                  !isBlackButton,
              }
            )}
          >
